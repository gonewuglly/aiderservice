...
<body>
    ...
    <div class="mb-nav">
        ...
        <div class="mb-nav-item active ">
            <a href="service.php">
                <center><i class='icofont-tasks-alt '></i></center>
                <div class="nav-text active">รายการงาน</div>
            </a>
        </div>
        <div class="mb-nav-item">
            <a href="chat.php">
                <center><i class='fas fa-comments'></i></center>
                <div class="nav-text">แชท</div>
            </a>
        </div>
        <div class="mb-nav-item">
            <a href="profile.php">
                <center><i class='bx bxs-user'></i></center>
                <div class="nav-text">ฉัน</div>
            </a>
        </div>
    </div>
    <!-- END MOBILE NAV -->
    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center">
            ...
            <!-- .nav-menu -->
            <a href="Login.php" style="padding-left:20px">ลงชื่อเข้าใช้</a>
        </div>
    </header>
    <!-- End Header -->
